package com.xianglin.game.web.filter;

import com.xianglin.game.utils.AppSessionContext;
import com.xianglin.game.web.utils.WebUtil;
 ...
 */
@WebFilter(filterName = "sessionFilter", urlPatterns = {"/forward/act/api/game/plane/*"})
public class SessionFilter implements Filter {
    ...
    private boolean checkLogin() {
        return AppSessionContext.ofPartyId().isPresent();
    }
